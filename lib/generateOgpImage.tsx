...
export const writeOgpImage = async (
	articleTitle: string,
	datetime: string,
	slug: string,
) => {
...
const generateOgpImage = async (title: string, date: string) => {
	const fontShippori = fs.readFileSync(
		"public/font/ShipporiMinchoB1-Medium.ttf",
	);
	const fontBaskervville = fs.readFileSync(
		"public/font/Baskervville-Regular.ttf",
	);
